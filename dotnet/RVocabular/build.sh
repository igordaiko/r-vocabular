...
scp -o StrictHostKeyChecking=no -i "private_key" ../dotnet/RVocabular/r-vocabular-host.tar.gz ${USER_NAME}@${HOST_NAME_1}:/r-vocabular-host
scp -o StrictHostKeyChecking=no -i "private_key" ../dotnet/RVocabular/r-vocabular-host.tar.gz ${USER_NAME}@${HOST_NAME_2}:/r-vocabular-host
